        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-4">
            ...
            <a
              ...
              className="flex items-center gap-5 bg-green-500 hover:bg-green-600 rounded-2xl p-7 transition-all duration-200 card-lift group shadow-md shadow-green-200"
            >
            ...
            <a
              href={MAIL}
              className="flex items-center gap-5 bg-white border border-gray-100 hover:border-yellow-300 rounded-2xl p-7 transition-all card-lift group shadow-sm"
            >
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">centrogalileu@gmail.com</p>
                <p className="text-gray-400 text-xs mt-1 group-hover:text-yellow-600 transition-colors">Enviar mensagem →</p>
              </div>
            </a>

            {/* Phone */}
            <div className="flex items-center gap-5 bg-white border border-gray-100 rounded-2xl p-7 shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">+244 946 038 986</p>
                <p className="text-gray-400 text-xs mt-1">Disponível das 8h às 20h</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5 bg-white border border-gray-100 rounded-2xl p-7 shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-400 text-xs mt-1">Online e ao Domicílio</p>
              </div>
            </div>
          </div>

          {/* Right: info panel */}
          <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-10 flex flex-col justify-between">
            <div>
              <h3 className="text-gray-900 font-extrabold text-2xl mb-6">
              ...
              <ul className="space-y-5 mb-8">
                {[
                  ...
                  { emoji: "💬", title: "Sem pressão",                desc: "Conversamos, entendemos as necessidades e propomos a melhor solução." },
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full bg-green-500 hover:bg-green-600 text-white font-bold py-4 rounded-full text-base transition-all shadow-md shadow-green-200 hover:scale-[1.02]"
            >
