      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-4">
            ...
            <a href={MAIL}
              className="flex items-center gap-5 rounded-2xl p-7 transition-all card-lift group contact-email-card">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "rgba(22,163,74,0.12)" }}>
                <Mail size={24} className="text-green-500" />
              </div>
              <div>
                <p className="font-bold text-lg" style={{ color: "#ffffff" }}>Email</p>
                <p className="text-sm" style={{ color: "#e2e8f0" }}>centrodeestudovirtus@gmail.com</p>
                <p className="text-xs mt-1 transition-colors group-hover:text-green-400" style={{ color: "#94a3b8" }}>
                  Enviar mensagem →
                </p>
              </div>
            </a>
              ...
              <ul className="space-y-5 mb-8">
                {[
                  ...
                  <li key={title} className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-sm" style={{ color: "#ffffff" }}>{title}</p>
