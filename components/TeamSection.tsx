    ...
    <section className="section-gray py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="inline-block text-yellow-700 text-sm font-semibold tracking-widest uppercase mb-3">A nossa equipa</span>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-4">
            Professores <span className="gradient-text">Qualificados</span>
          </h2>
          <p className="max-w-2xl mx-auto text-gray-700 text-lg">A qualidade do acompanhamento começa com a qualidade dos professores.</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {credentials.map(({ icon: Icon, title, desc, iconBg, iconColor }) => (
            <div key={title} className="card-lift bg-white rounded-2xl border border-gray-200 shadow-sm hover:border-yellow-300 hover:shadow-md p-7 text-center transition-all">
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm px-8 py-8 text-center">
