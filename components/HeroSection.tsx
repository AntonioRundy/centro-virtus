...
export default function HeroSection() {
  return (
    <section id="inicio" className="section-white min-h-screen flex items-center pt-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* Subtitle */}
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8 max-w-lg animate-fade-up delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 animate-fade-up delay-300">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#f4b400] hover:bg-[#e0a800] text-gray-900 font-bold text-base px-8 py-4 rounded-full transition-all duration-200 shadow-lg hover:scale-[1.03]"
              >
                Comece Agora
                <ArrowRight size={18} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 border-2 border-gray-300 hover:border-green-600 text-gray-700 hover:text-green-700 font-semibold text-base px-8 py-4 rounded-full transition-all duration-200 hover:bg-green-50"
              >
            ...
            {/* Trust line */}
            <p className="text-gray-600 text-sm mb-8 animate-fade-up delay-300">
            ...
            <div className="grid grid-cols-3 gap-3 animate-fade-up delay-400">
              {stats.map(({ icon: Icon, value, label }) => (
                <div key={label} className="bg-gray-50 border border-gray-200 rounded-2xl px-4 py-4 text-center">
                  ...
                  <p className="text-gray-600 text-xs mt-1 leading-tight">{label}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 animate-fade-up delay-200">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-gray-300 h-[480px] lg:h-[560px] bg-yellow-50">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-4 shadow-xl">
                ...
                <p className="text-gray-600 text-xs mt-0.5">Experimente sem compromisso — fale connosco hoje.</p>
              </div>
            </div>

            {/* Accent cards below image */}
            <div className="flex gap-3 mt-4">
              <div className="flex-1 rounded-2xl px-4 py-3 text-center" style={{ backgroundColor: "#f4b400" }}>
                <p className="text-gray-900 font-extrabold text-xl">+200</p>
                <p className="text-yellow-900 text-xs font-medium">Alunos</p>
              </div>
